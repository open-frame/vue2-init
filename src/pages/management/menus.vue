<template>
  <el-card shadow="never" class="menus">
    <el-row :gutter="40" class="filters">
      <el-col :span="4">
        <el-input
          clearable
          v-model="form.menuName"
          placeholder="请输入菜单名称进行检索"
        ></el-input>
      </el-col>
      <el-col :span="4">
        <el-select
    ...
    <el-divider />
    <el-button-group>
      <el-button icon="el-icon-plus" @click="addMenu('')">新增</el-button>
    ...
    >
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="addMenu(scope.row)"
            >新增</el-button
          >
          <el-button size="mini" @click="editMenu(scope.row)">编辑</el-button>
          <el-button size="mini" type="danger" @click="deletMenu(scope.row)"
            >删除</el-button
          >
        </template>
      </el-table-column>
